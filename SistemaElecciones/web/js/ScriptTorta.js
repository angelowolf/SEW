        ...
        $.ajax({
            ...
            success: function (resultadoJsonData) {
                ...
                $.each(resultadoJsonData, function (index, aResultado) {
                    datosPie = [
                        {
                            value: aResultado.resultado_escrutado,
                            color: "lightblue",
                            label: 'Escrutado  ' + aResultado.resultado_escrutado,
                            labelColor: "white",
                            labelFontSize: '25'
                        }, {
                            value: aResultado.resultado_restante,
                            color: "steelblue",
                            label: 'Restante  ' + aResultado.resultado_restante,
                            labelColor: "white",
                            labelFontSize: '25'
                        }
                    ];
...
var Script_Dos = {
                    ...
                    datos = [
                        {
                            ...
                            value: aResultado.resultado_total,
                            color: "darkblue",
                            label: 'TOTAL' + aResultado.resultado_total,
                            labelColor: "white",
                            labelFontSize: '25'
                        }
                    ]
    ...
    /*Renders the Chart on a canvas and returns the reference to chart*/
    graficoTorta: function (data) {
        var context2D = document.getElementById("canvas2").getContext("2d"),
                myBar = new Chart(context2D).
                Bar(data, {
                    barShowStroke: true
                });
        return myBar;
...
//    },
//    /*Renders the Chart on a canvas and returns the reference to chart*/
//    renderStudenrRadarChart2: function(barChartData) {
//
//        var context2D = document.getElementById("canvas2").getContext("2d"),
//                myBar = new Chart(context2D).
//                Bar(barChartData, {
...
//    initRadarChart2: function() {
//
//        var studentData = Script_Uno.loadStudentData2();
//
//        chartData = Script_Uno.createChartData2(studentData);
//
//        radarChartObj = Script_Uno.renderStudenrRadarChart2(chartData);
//
//    }
